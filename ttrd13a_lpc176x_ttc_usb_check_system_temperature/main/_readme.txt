/*--------------------------------------------------------------------*-
   ...
   Time-Triggered Reference Design (TTRD13a)
   ...
   Incorporates TTC task scheduler
   with temperature monitoring as part of the System Contract.

   includes lightweight resource barriers.
