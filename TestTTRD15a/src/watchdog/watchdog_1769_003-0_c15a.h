/*--------------------------------------------------------------------*-
   ...
   watchdog_1769_003-0_c15a.h (Released 2015-02)

  --------------------------------------------------------------------
   
   - See watchdog_1769_003-0_c15a.c for details.
...
// Define divider index for microsecond 
#define WDT_US_INDEX ((uint32_t)(1000000))

// WDT Time out minimum value 
// Este valor lo modificamos porque ahora nuestro valor normal es 9
#define WDT_TIMEOUT_MIN ((uint32_t)(0x05))

// WDT Time out maximum value 
//Lo cambiamos tambien aunque no afecta para que no quede tan lejos del min
#define WDT_TIMEOUT_MAX ((uint32_t)(0xFF))

// WDT PCLK value
#define WDT_PCLK (32768)
