/*--------------------------------------------------------------------*-
    ...
    system_state_lh_1769_003-0_c15a.h (Released 2015-02)

  --------------------------------------------------------------------
   
   - See system_state_lh_1769_003-0_c15a.c for details.
...
#ifndef _SYSTEM_STATE_LH_H
#define _SYSTEM_STATE_LH_H 1

// ------ Public data type declarations ----------------------------

// Possible system states
// Note: Faults are handled by mode change
typedef enum {INIT_LH, WAIT_FOR_DRUM_TO_STOP_LH, DRAIN_DRUM_LH}
              eSystem_state_lh;
