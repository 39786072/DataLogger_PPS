/*--------------------------------------------------------------------*-
   ...
   system_self_test_mcu_temperature_1769_003-0_c15a.h (Released 2015-02)
 
  --------------------------------------------------------------------

   - See system_check_mcu_temperature_1769_003-0_c15a.c for details.
...
#ifndef _SYSTEM_SELF_TEST_MCU_TEMP_H
#define _SYSTEM_SELF_TEST_MCU_TEMP_H 1

// ------ Public function prototypes -------------------------------

void SYSTEM_SELF_TEST_Check_MCU_temp_Init(void);
uint32_t SYSTEM_SELF_TEST_Check_MCU_temp(void);
