/*--------------------------------------------------------------------*-
   ...
   system_mode_1769_003-0_c15a.h (Released 2015-02)

  --------------------------------------------------------------------

   See system_mode_1769_003-0_c15a.c for details.
...
#ifndef _SYSTEM_MODE_H
#define _SYSTEM_MODE_H 1

#include "../main/main.h"

// Possible system modes
typedef enum {FAIL_SILENT, LIMP_HOME, NORMAL} eSystem_mode;
