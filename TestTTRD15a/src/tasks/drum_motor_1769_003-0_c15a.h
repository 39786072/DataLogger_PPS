/*--------------------------------------------------------------------*-
    ...
    drum_motor_1769_003-0_c15a.h (Released 2015-02)

  --------------------------------------------------------------------
   
   - See  drum_motor_1769_003-0_c15a.c for details.
...
#ifndef _DRUM_MOTOR_H
#define _DRUM_MOTOR_H 1

// ------ Public constants -----------------------------------------

// Percentage of maximum speed
#define MAX_DRUM_MOTOR_SPEED (100)

// Maximum time it should take the drum to stop after power removed
// Time in seconds
#define MAX_DRUM_STOP_DURATION (12)
