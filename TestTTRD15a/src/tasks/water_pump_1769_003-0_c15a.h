/*--------------------------------------------------------------------*-
    ...
    water_pump_1769_003-0_c15a.h (Released 2015-02)

  --------------------------------------------------------------------
   
   - See  water_pump_1769_003-0_c15a.c for details.
...
#define _WATER_PUMP_H 1

// ------ Public constants ----------------------------------------

// Maximum time it should take to drain the drum if pump is OK.
// Time in seconds
#define MAX_DRUM_DRAIN_DURATION (30)
