/*--------------------------------------------------------------------*-
    ...
    water_heater_1769_003-0_c15a.h (Released 2015-02)

  --------------------------------------------------------------------
   
   - See  water_heater_1769_003-0_c15a.c for details.
...
#ifndef _WATER_HEATER_H
#define _WATER_HEATER_H 1

// ------ Public constants -----------------------------------------

// Maximum time it should take to heat the water in the drum
// if the heater unit is operating correctly.
// Timing in seconds.
#define MAX_WATER_HEAT_DURATION (30)
