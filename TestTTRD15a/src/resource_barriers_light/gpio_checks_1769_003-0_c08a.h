/*--------------------------------------------------------------------*-
   ...
   gpio_checks_1769_003-0_c08a.h (Released 2015-02)

  --------------------------------------------------------------------
   
   - See gpio_checks_1769_003-0_c08a.c for details.
...
#ifndef _GPIO_CHECKS_H
#define _GPIO_CHECKS_H 1

#include "../main/main.h"

// ------ Public function prototypes -------------------------------

uint32_t GPIO_Check_Output(const uint8_t, const uint32_t);
uint32_t GPIO_Check_Input(const uint8_t, const uint32_t);
