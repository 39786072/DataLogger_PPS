/*--------------------------------------------------------------------*-
  ...
  system_1769_003-0_c02c.c (Released 2015-02)
...
// Task headers
#include "../tasks/heartbeat_1769_003-0_c02b.h"
...
void SYSTEM_Configure_Required_Mode(void)
   ...
   switch (System_mode_G)
      ...
      case NORMAL:
         ...
         // LONGER TIMEOUT HERE: allow scheduler to detect overloads. 
         WATCHDOG_Init(10000);

         // Set up scheduler for 1 ms ticks 
         // NOTE: tick interval in *microseconds* for this scheduler
         SCH_Init(1000);
         ...
         // Add heartbeat task
         // This task will overrun after ~15 seconds 
